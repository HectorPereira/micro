...
\paragraph{Configuracion de USART}---\\
...
\paragraph{Variables globales - PORTD}---\\
...
\paragraph{Calculo trigonometrico}---\\
...
\paragraph{Deteccion de contorno}---\\
