...
\subsubsection{\textbf{Piano}}---
    ...
    No se detectaron desfasajes entre tonos ni interrupciones durante la ejecución, lo que confirmó la estabilidad temporal del módulo. Las canciones fueron reproducidas con continuidad y volumen uniforme, evidenciando un control adecuado sobre la temporización y la generación de frecuencias.

    \paragraph*{\textbf{Modos de funcionamiento y comunicación USART}}---

    Durante la verificación de los modos de operación, se comprobó que el sistema respondía correctamente tanto en el modo \textbf{piano} (manual) como en el modo \textbf{automático} (canciones). La interfaz serial \textbf{USART} permitió alternar entre los modos de forma confiable, así como iniciar y detener la reproducción desde la terminal. La comunicación se mantuvo estable a 9600~bps, sin pérdida de datos ni interferencia con la reproducción del sonido. El menú mostrado en la terminal facilitó el control y la supervisión del sistema durante las pruebas.
