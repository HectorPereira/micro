...
\paragraph*{Limpieza del búfer WS2812}\label{anexo:WSclear}---\\
\begin{lstlisting}[language=C, caption={Función ws2812 clear}]
	
>>>>>>> 738c9c2dec575a610458c9916c49dd4ca75451b8
...
<<<<<<< HEAD
=======
\paragraph*{Encender un LED puntual}\label{anexo:WSturn}---\\
\begin{lstlisting}[language=C, caption={Encendido puntual de LED por coordenadas}]
>>>>>>> 738c9c2dec575a610458c9916c49dd4ca75451b8
